...
|----------|-------------------------------------------|---------------------------------------|
| 🚩 P0    | Prompt truncation enforcement             | backend/engine/model.py               |
| 🚩 P0    | Max token cap enforcement per model       | backend/engine/model.py               |
| ⚠️ P1    | Pre-generation token estimation           | backend/engine/model.py               |
| ⚠️ P1    | Prompt schema validation                  | backend/engine/model.py               |
